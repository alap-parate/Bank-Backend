...
class GL_Master(models.Model):
    ...
    pl_bl = models.CharField(max_length=1,choices=(Choices))
    acc_type = models.ForeignKey(Acc_type, on_delete=models.PROTECT)
    group_id = models.ForeignKey(Group_Master, on_delete=models.PROTECT)
    int_code = models.IntegerField(default=0,null=True)
    pr_int_code = models.IntegerField(default=0, null=True)
    due_amnt = models.DecimalField(default=0, decimal_places=2,max_digits=10)
    int_cal_type = models.DecimalField(default=0, decimal_places=2,max_digits=10)
    due_cal_type = models.DecimalField(default=0, decimal_places=2,max_digits=10)
